...
{
	var query = $('input').val();
	$.getJSON('http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=58c74a5f0c591d876cd4e538991a5177&text=' + query + '&per_page=' + per_page + '&page=' + page + '&format=json&jsoncallback=?', flickr_finished);
}
